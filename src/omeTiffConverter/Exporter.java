...
public class Exporter {
    ...
    public Exporter(LociExporter plugin, ImagePlus image) {
        this.plugin = plugin;
        this.image = image;
    }

    public void Run() throws DependencyException, ServiceException, FormatException, IOException, EnumerationException{
